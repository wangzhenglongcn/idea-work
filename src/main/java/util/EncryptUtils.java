...
public class EncryptUtils {
    ...
    private String keyGeneratorES(String res, String algorithm, String key, int keysize,
        ...
        try {
            ...
            if (isEncode) {
                ...
                return new String(cipher.doFinal(parseHexStr2Byte(res)), Charset.forName("utf-8"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            //加密串
            String result = EncryptUtils.me.DESencode(str, "123");
            System.out.println("加密后：" + result);
            //直接将如上内容解密
            String decryResult = EncryptUtils.me.DESdecode(result, "123");
